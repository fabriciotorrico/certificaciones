                ...
                <td class="td_linea_arriba_derecha" rowspan="3">
                  <table>
                    <tr>
                      ...
                      <td class="valores">
                        <?php if (isset($transferencia['supterreno'])) {echo number_format($transferencia['supterreno'], 2, '.', ',');} ?>
                      </td>
                    </tr>
          ...
          <table border="0">
            ...
            <tr>
              ...
              <td width="250px">
                <table class="tabla_con_borde_y_divisiones">
                  <tr>
                    <td><div class="subtitulo">PMC:</div></td>
                    <td><div class="valores"><?php if (isset($transferencia['baseimponible'])) {echo number_format($transferencia['baseimponible'], 2, '.', ',');} ?></div></td>

                    <td rowspan="3">&nbsp;&nbsp;</td>

                    <td><div class="subtitulo">MINUTA:</div></td>
                    <td><div class="valores"><?php if (isset($transferencia['fechminuta'])) {echo $transferencia['fechminuta'];} ?></div></td>
                  </tr>

                  <tr>
                    <td><div class="subtitulo">EMITIDO:</div></td>
                    <td><div class="valores"><?php if (isset($transferencia['fechliqui'])) {echo $transferencia['fechliqui'];} ?></div></td>

                    <td><div class="subtitulo">VALOR VENTA:</div></td>
                    <td><div class="valores"><?php if (isset($transferencia['montobs'])) {echo "Bs. ".$transferencia['montobs'];} ?></div></td>
                  </tr>

                  <tr>
                    <td><div class="subtitulo">VENCE:</div></td>
                    <td><div class="valores"><?php if (isset($transferencia['fechvenci'])) {echo $transferencia['fechvenci'];} ?></div></td>

                    <td><div class="subtitulo">BASE IMPONIBLE:</div></td>
                    <td><div class="valores"><?php if (isset($transferencia['baseimponible'])) {echo number_format($transferencia['baseimponible'], 2, '.', ',');} ?></div></td>
                  </tr>
                </table>
                <div class="titulo">
                  <p>TOTAL: <?php echo number_format($total, 2, '.', ',');?> SON: <?php echo $total_literal;?></p>
                </div>
              </td>
            </tr>
          </table>
    ...
    <table width="700px" border="0">
      <tr>
        <td width="1px">
          <div class="encabezado">
            <?php
             if ($i == 1) {echo "V<br>E<br>N<br>D<br>E<br>D<br>O<br>R";}//{echo "<p class='texto_vertical'> NOTARIA <p>";}
             else {echo "C<br>O<br>M<br>P<br>R<br>A<br>D<br>O<br>R";}//{echo "<p class='texto_vertical'> COMPRADOR <p>";}
            ?>
          </div>
        </td>
        ...
        <td>
          ...
          <table class="tabla_con_borde">
            ...
            <tr>
              <td colspan="5">
                <div class="valores">
                  <?php if (isset($comprador['rep_legal'])) {echo $comprador['rep_legal'];}?>
                </div>
              </td>
            </tr>
          </table>
        ...
        <td>
          <table class="tabla_con_borde">
            <tr><td><div class="subtitulo_izquierda_negrita">SUPERFICIE TERRENO:</div></td></tr>
            <tr><td><div class="valores_centrado"><?php if (isset($transferencia['supterreno'])) {echo number_format($transferencia['supterreno'], 2, '.', ',');} ?></div></td></tr>
            <tr><td><div class="subtitulo_izquierda_negrita">SUPERFICIE CONSTRUIDA:</div></td></tr>
            <tr><td><div class="valores_centrado"><?php if (isset($transferencia['supedif'])) {echo number_format($transferencia['supedif'], 2, '.', ',');} ?></div></td></tr>
          </table>
        </td>
